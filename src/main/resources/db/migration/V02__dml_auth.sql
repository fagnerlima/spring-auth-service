...
BEGIN
  ...
  INSERT INTO auth.usuario (id, nome, email, valor_senha, pendente, bloqueado, data_criacao, id_usuario_criacao, data_atualizacao, id_usuario_atualizacao) VALUES
    (1, 'Administrador', 'admin@email.com', '$2a$10$NjHXi93qH9xoxYjk4nGiauYwVcK5qQTDxl7itopsOixNhL05396.K', FALSE, FALSE, NOW(), 1, NOW(), 1);
